...
public class BottomBarItem extends LinearLayout {
    ...
    private void initAttrs(TypedArray ta) {
        ...
        mTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemTextSize,mTextSize);
        ...
        mMsgTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_msgTextSize, mMsgTextSize);
    ...
    private void init() {
        ...
        RelativeLayout.LayoutParams textLayoutParams = (RelativeLayout.LayoutParams) mTextView.getLayoutParams();
