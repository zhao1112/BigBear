 ...
 * On 2019/1/22 10:40
 */
public class ICustomDialog2 extends Dialog implements View.OnClickListener {
    ...
    public interface OnDialogItemClickListener {
        void onDialogItemClick(ICustomDialog2 thisDialog, View clickView);
    }


    public ICustomDialog2() {
    ...
    public static class Builder {
        ...
        public ICustomDialog2 build() {
            return new ICustomDialog2();
        }
    }
