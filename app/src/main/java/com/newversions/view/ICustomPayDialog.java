 ...
 * On 2019/1/22 10:40
 */
public class ICustomPayDialog extends Dialog implements View.OnClickListener {
    ...
    private static String dialogPayTitle;
//    private static String dialogPayContent;
    ...
    public interface OnDialogItemClickListener {
        void onDialogItemClick(ICustomPayDialog thisDialog, String pwd);
    }


    public ICustomPayDialog() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_version_dialog_pay_layout);
        setCanceledOnTouchOutside(iCanceledOnTouchOutside);
        setCancelable(iCancelable);

        if (null != dialogPayTitle && !"".equals(dialogPayTitle)) {
            TextView title = findViewById(R.id.dialog_pay_title);
            title.setText(dialogPayTitle);
        }
//        if (null != dialogPayContent && !"".equals(dialogPayContent)) {
//            TextView title = findViewById(R.id.dialog_pay_content);
//            title.setText(dialogPayContent);
//        }
    ...
    public static class Builder {
        ...
        public Builder setOnDialogTitle(String dialogTitle) {
            dialogPayTitle = dialogTitle;
            return this;
        }

        public Builder setOnDialogContent(String dialogContent) {
//            dialogPayContent = dialogContent;
            return this;
        }
        ...
        public ICustomPayDialog build() {
            return new ICustomPayDialog();
        }
    }
