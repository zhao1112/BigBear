...
public class ArticleHistoryFlowLayout extends ViewGroup {

    private LayoutInflater mInflater;
    private boolean isColorful;

    public ArticleHistoryFlowLayout(Context context) {
        this(context, null);
    }

    public ArticleHistoryFlowLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ArticleHistoryFlowLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setListData(List<String> list) {
        ...
        int count = list.size();
        for (int i = 0; i < count; i++) {
            final View view = mInflater.inflate(R.layout.article_hot, this, false);
            TextView tv = view.findViewById(R.id.hot_conten);
