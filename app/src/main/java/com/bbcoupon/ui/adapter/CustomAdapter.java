...
public class CustomAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<CustomInfor.CommodityListBean> list;
    //设置图片圆角角度
    RoundedCorners roundedCorners = new RoundedCorners(8);
    RequestOptions options = RequestOptions.bitmapTransform(roundedCorners);

    public void addList(List<CustomInfor.CommodityListBean> list) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        CustomAdapter.ProductSunHolder productSunHolder = (CustomAdapter.ProductSunHolder) holder;
        if (position == 0) {
    ...
    public interface onClickProductSumItem2 {
        void onItem(int position, CustomInfor.CommodityListBean bean);
    }
