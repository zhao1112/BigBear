...
public class CompletedView extends View {
    ...
    public CompletedView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public CompletedView(Context context, AttributeSet attrs) {
        ...
        //中间圆的背景颜色  默认为浅紫色
        mCircleBackground = typedArray.getColor(R.styleable.PercentageRing_comp_circleBackground, 0xffafb4db);
        //外圆环的颜色  默认为深紫色
        mRingColor = typedArray.getColor(R.styleable.PercentageRing_comp_ringColor, 0xff6950a1);
        //中间圆的半径 默认为60
        mRadius = typedArray.getInt(R.styleable.PercentageRing_comp_radius, 60);
        //字体颜色 默认为白色
        mTextColor = typedArray.getColor(R.styleable.PercentageRing_comp_textColor, 0xffffffff);
