...
public class ZeroDetailsImgViewPagerAdapter extends PagerAdapter{

    private Context mContext;
    private List<ZeroActivityBean.DataBean.GroupPurchasingItemBean.ProductImagesBean> mProductImagesList;
    private List<ImageView> mImageViewList;
    private LayoutInflater mInflater;
    public ZeroDetailsImgViewPagerAdapter(Context mContext, List<ZeroActivityBean.DataBean.GroupPurchasingItemBean.ProductImagesBean> mProductImagesList) {
