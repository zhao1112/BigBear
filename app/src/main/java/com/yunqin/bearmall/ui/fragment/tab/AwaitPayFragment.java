...
import com.yunqin.bearmall.ui.fragment.presenter.AwaitPayPresenter;
 ...
 * 待付款页面
 */
public class AwaitPayFragment extends LazyFragment implements TabFragmentContract.UI, AllFragmentAdapter.OnChildClickListener {
    ...
    public void init() {
        ...
        isViewCreated = true;
        presenter = new AwaitPayPresenter(getActivity(), this);
    ...
    public void onUpdate(OrderTypeUpdate update) {
        if (update.getId() == MineOrderActivity.FragmentType.AWAIT_ZHIFU) {
            isUpdate = true;
        }
    }
