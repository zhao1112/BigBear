...
import com.newversions.SystemAdapter;
...
public class SystemMessageActivity extends BaseActivity implements View.OnClickListener {
    ...
    private SystemAdapter moneyRewardAdapter;
    ...
    private void initData() {
        ...
        getHttpData(mHashMap, new RetrofitApi.IResponseListener() {
            ...
            public void onSuccess(String data) throws JSONException {
                SystemMessageData moneyRewardBean = new Gson().fromJson(data, SystemMessageData.class);
                if (moneyRewardBean.getData() != null && moneyRewardBean.getData().getList() != null) {
                    ...
                    if (moneyRewardBean.getData().getList().size() > 0) {
                        mTwinklingRefreshLayout.setVisibility(View.VISIBLE);
                        moneyRewardAdapter = new SystemAdapter(SystemMessageActivity.this, moneyRewardBean.getData().getList());
    ...
    private void changeView(boolean hasMore) {
        hasNext = hasMore;
        if (hasNext) {
            mTwinklingRefreshLayout.setBottomView(new RefreshBottomView(SystemMessageActivity.this));
        } else {
            mTwinklingRefreshLayout.setBottomView(new RefreshFooterView(SystemMessageActivity.this));
        }
    }
