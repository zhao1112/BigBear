...
public class MinePresenter implements MineContract.Presenter {
    ...
    public void getOrderNumberInfo(Context context) {
        RetrofitApi.request(context, RetrofitApi.createApi(Api.class).getOrdersQuantity(new HashMap<>()), new RetrofitApi.IResponseListener() {
            @Override
            public void onSuccess(String data) {
                assert view != null;
    ...
    public void updateUserInfo(Context context) {
        ...
        if (BearMallAplication.getInstance().getUser() != null) {
            RetrofitApi.request(context, RetrofitApi.createApi(Api.class).getMemberInfo(new HashMap<>()), new RetrofitApi.IResponseListener() {
                @Override
                public void onSuccess(String data) {
