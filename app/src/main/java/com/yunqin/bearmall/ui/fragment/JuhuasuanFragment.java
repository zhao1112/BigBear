...
import com.yunqin.bearmall.adapter.JuhuasuanAdapter;
 ...
 * @DATE 2020/4/8
 */
public class JuhuasuanFragment extends BaseFragment {
    ...
    public void init() {
        ...
        JuhuasuanAdapter hotAdapter = new JuhuasuanAdapter(getActivity(), getChildFragmentManager(), stringList, mType);
