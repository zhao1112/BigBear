...
public class BargainStrategyDialog extends BaseDialog {
    private Context mContext;

    public BargainStrategyDialog(@NonNull Context context) {
        super(context, R.style.ProductDialog);
        mContext = context;

        View view = LayoutInflater.from(context).inflate(R.layout.dialog_bargain_strategy, null);
