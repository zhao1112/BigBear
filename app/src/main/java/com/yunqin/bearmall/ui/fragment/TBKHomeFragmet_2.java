...
import com.newversions.tbk.fragment.NewVersionTBKHomeContract;
import com.newversions.tbk.fragment.NewVersionTBKHomePresenter;
 ...
 * @DATE 2020/3/20
 */
public class TBKHomeFragmet_2 extends BaseFragment implements NewVersionTBKHomeContract.View, NewVersionTBKHomeAdapter2.OnItemClickListener {
    ...
    private NewVersionTBKHomeAdapter2 mNewVersionHomeAdapter;
    ...
    public void init() {
        ...
        mNewVersionHomeAdapter = new NewVersionTBKHomeAdapter2(getActivity(), image);
    ...
    public void onHasMore(boolean hasMore) {
        ...
        if (!hasMore) mTwinklingRefreshLayout.setBottomView(new RefreshFooterView(getActivity()));
    }
    ...
    @Override
    public void TBHome(NewTBHome newTBHome) {
        Log.e("TBHome", "TBHome: ");
        mNoNetView.setVisibility(View.GONE);
