...
public class ServiceInstructionDialog extends BaseDialog{
    private Context mContext;

    public ServiceInstructionDialog(@NonNull Context context) {
        super(context, R.style.ProductDialog);
        mContext = context;

        View view = LayoutInflater.from(context).inflate(R.layout.dialog_service_instruction,null);
