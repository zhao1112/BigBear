...
public class DuoBaoInfoMationDialog extends BaseDialog{
    private Context mContext;

    public DuoBaoInfoMationDialog(@NonNull Context context) {
        super(context, R.style.ProductDialog);
        mContext = context;

        View view = LayoutInflater.from(context).inflate(R.layout.dialog_duobao_instruction,null);
