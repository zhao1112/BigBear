...
import com.yunqin.bearmall.ui.fragment.presenter.AwaitReceivePresenter;
 ...
 * 待收货界面
 */
public class AwaitReceiveFragment extends LazyFragment implements TabFragmentContract.UI, AllFragmentAdapter.OnChildClickListener {
    ...
    public void init() {
        ...
        presenter = new AwaitReceivePresenter(getActivity(), this);
    ...
    protected void lazyLoad() {
        ...
        if (isPrepared && isVisible && !isFirst) {
            Log.e("CHENGPAN", "刷新*待收货*" + "AwaitReceiveFragment");
            presenter.shuaXin();
        }
    ...
    public void onUpdate(OrderTypeUpdate update) {
        if (update.getId() == MineOrderActivity.FragmentType.AWAIT_SHOUHUO) {
            isUpdate = true;
        }
    }
