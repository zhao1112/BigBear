...
public class BalanceWithdrawalActivity extends BaseActivity implements View.OnClickListener {
    ...
    public static void startActivity(Context context, String money) {
        Intent intent = new Intent(context, BalanceWithdrawalActivity.class);
    ...
    private void initViews() {
        ...
        findViewById(R.id.yhk_visible).setVisibility(View.VISIBLE);
        findViewById(R.id.wx_visible).setVisibility(View.GONE);
    ...
    private void setBankData(BankBean.DataBean.ListBean listBean) {
        ...
        Glide.with(BalanceWithdrawalActivity.this).load(bankBean.getData().getList().get(0).getIcon()).into(bank_icon);
    }
        ...
        RetrofitApi.request(this, RetrofitApi.createApi(Api.class).calculateWithdrawAmount(map), new RetrofitApi.IResponseListener() {
            ...
            public void onSuccess(String data) throws JSONException {
                ...
                if (jsonObject.optInt("code") != 1) {
                    Toast.makeText(BalanceWithdrawalActivity.this, jsonObject.optString("msg"), Toast.LENGTH_SHORT).show();
                    return;
                }
                JSONObject js = jsonObject.optJSONObject("data");

                new DrawMoneyDialog.Builder(BalanceWithdrawalActivity.this)
                        ...
                        .setOnDialogItemClickListener(new DrawMoneyDialog.OnDialogItemClickListener() {
                            ...
                            public void onDialogItemClick(final DrawMoneyDialog thisDialog, String data) {
                                ...
                                RetrofitApi.request(BalanceWithdrawalActivity.this, RetrofitApi.createApi(Api.class).validPayPassword(mHashMap), new RetrofitApi.IResponseListener() {
                                    @Override
                                    public void onSuccess(String data) throws JSONException {
                                        ...
                                        wcnmap.put("userBankId", bankBean.getData().getList().get(selectPosition).getUserBankId() + "");
                                        ...
                                        RetrofitApi.request(getApplicationContext(), RetrofitApi.createApi(Api.class).applyWithdraw(wcnmap), new RetrofitApi.IResponseListener() {
                                            ...
                                            public void onSuccess(String data) throws JSONException {
                                                ...
                                                WithdrawActivity.startActivity(BalanceWithdrawalActivity.this);
                ...
                .setOnDialogItemClickListener(new IBankDialog.OnDialogItemClickListener() {
                    ...
                    public void onDialogItemClick(IBankDialog thisDialog, View clickView) {
                        ...
                        if (R.id.add_bank == clickView.getId()) {
                            BankAddVerifyActivity.startActivity(BalanceWithdrawalActivity.this, BankAddVerifyActivity.BankVerify.BANK_ADD, "0");
                        } else {
    ...
    public void EventGet(UpdateBankListEvent event) {
