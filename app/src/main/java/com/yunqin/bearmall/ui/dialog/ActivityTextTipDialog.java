...
public class ActivityTextTipDialog extends BaseDialog{
    private Context mContext;

    public ActivityTextTipDialog(@NonNull Context context) {
        super(context, R.style.ProductDialog);
        mContext = context;

        View view = LayoutInflater.from(context).inflate(R.layout.dialog_activity_zero_instruction,null);
