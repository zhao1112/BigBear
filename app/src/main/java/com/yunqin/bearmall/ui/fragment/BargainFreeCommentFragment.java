...
public class BargainFreeCommentFragment extends BaseFragment implements ProductCommentFragmentContact.UI{
...
//    TextView empty_text;
    ...
    public void Event(BargainFreeEvent messageEvent) {
        Log.e("BargainFreeEvent", messageEvent.getMessage());
